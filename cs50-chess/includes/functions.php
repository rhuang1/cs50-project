<?php
    ...
    /**
    * Gets user's information from the database and stores it in
    * an array.
    */
	...
	/**
	* Finds the user who is currently in the game specified
	*/
	
	function getUserGame($gameID)
	{
		$rows = query("SELECT username FROM users WHERE currentGame = ?", $gameID);
		return $rows[0];
	}
